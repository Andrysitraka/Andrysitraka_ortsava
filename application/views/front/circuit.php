	...
	<div class="container">
        ...
        <div class="agileits-line"> </div>
			...
			<div class="container" style="text-align: justify;">
				<h3 style="color:#aebe27;text-align:center;font-size:24px;font-familly:times;text-decoration:underline;">
				<?php foreach ($getnomcircuit as $key => $value){
					...
					<div class="panel panel-default">
							...
							<div id="collapse<?php echo $i;?>" class="panel-collapse collapse testy<?php echo $i;?>" role="tabpanel" aria-labelledby="heading<?php echo $i;?>">
								...
								<div class="col-md-4 col-sm-4 clo-xs-4">
									...
									<div class="col-md-8 col-sm-8"><p> <?php echo substr($value->contenu,0,500);?>....</br></br></br><?php echo anchor("Visitez/circuit_detail/{$value->id}", 'plus d info',['class'=>'btn btn-info'  ]); ?></p>
								</div>
